          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-4 gap-2 mb-6">
              {serviceData.thumbnails.map((thumbnail: string, index: number) => (
                <div
                  key={index}
                  className="border border-orange-500 rounded-lg overflow-hidden cursor-pointer"
                >
                ...
                <div className="flex items-center mb-6">
                  <div className="mr-4">
                    ...
                    <div className="text-sm text-gray-500 mt-1">
                      {serviceData.reviewCount} ulasan
                    </div>
                  </div>
              ...
              <TabsContent value="penyedia" className="p-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center mt-1">
                      ...
                      <span className="ml-2 text-sm text-gray-500">
                        {serviceData.provider.rating} Rating
                      </span>
                    </div>
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <p className="text-gray-700 mb-4">
                    Bengkel Jaya adalah penyedia jasa perbaikan atap profesional dengan pengalaman
                    lebih dari 5 tahun. Kami memiliki tim teknisi yang terlatih dan berpengalaman
                    dalam menangani berbagai jenis perbaikan atap.
                  </p>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm mb-6">
              ...
              <div className="text-sm text-gray-500 mb-4">
                Harga mulai dari {serviceData.priceRange}
              </div>
