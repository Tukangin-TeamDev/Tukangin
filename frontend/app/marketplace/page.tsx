      ...
      <section className="bg-gradient-to-b from-blue-500/60 to-white py-12">
        <div className="container mx-auto px-4 md:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-black mb-4">
            Temukan Layanan Tukang Profesional
          </h1>
            ...
            {serviceCategories.map(category => (
              <button
                ...
                onClick={() => {
                  ...
                  const categoryLabel =
                    serviceCategories.find(c => c.id === category.id)?.name || '';
      ...
      <section className="container mx-auto px-4 md:px-8 mb-12">
        <div className="flex justify-between items-center mb-6">
          ...
          <p className="text-sm text-gray-600">
            Menampilkan{' '}
            <span className="font-semibold text-blue-600">{filteredServices.length}</span> dari{' '}
