...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      // Use the updated authService for Google login
              ...
              <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                ...
                <div className="flex flex-col gap-3">
                  <button
                    ...
                    className="flex h-10 w-full items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500/50 active:bg-gray-100 disabled:opacity-70 sm:h-11"
                  >
                    {isGoogleLoading ? (
                    ...
                    <span>{isGoogleLoading ? 'Menunggu Google...' : 'Masuk dengan Google'}</span>
                  </button>
                </div>
              </form>
