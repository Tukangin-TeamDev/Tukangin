...
router.get(
  '/verify-email/:token',
  controllerAdapter(authController.verifyEmail.bind(authController))
);
router.post(
  '/forgot-password',
  controllerAdapter(authController.forgotPassword.bind(authController))
);
router.post(
  '/reset-password/:token',
  controllerAdapter(authController.resetPassword.bind(authController))
);
...
router.post(
  '/setup-2fa',
  verifyToken,
  controllerAdapter(authController.setup2FA.bind(authController))
);
