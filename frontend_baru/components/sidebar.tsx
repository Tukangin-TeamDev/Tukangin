...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      <Button variant="ghost" size="icon" className="absolute -right-10 top-3 md:hidden" onClick={toggleSidebar}>
      ...
      <div className="p-4 flex items-center">
        <h1 className={cn("font-bold text-2xl transition-opacity", isCollapsed ? "opacity-0 w-0" : "opacity-100")}>
          Dashboard
        </h1>
          ...
          <li>
            ...
            {!isCollapsed && isSubmenuOpen && (
              <ul className="ml-8 mt-1 border-l pl-2 space-y-1">
                <li>
                  <Link href="#" className="flex items-center gap-2 p-2 text-sm hover:text-blue-600">
                    Aktif
                  </Link>
                </li>
                <li>
