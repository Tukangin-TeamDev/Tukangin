      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link href="/home" className="text-black hover:text-blue-600 transition-colors border-b-2 border-blue-600">
              Home
            </Link>
            <Link
              href="/marketplace"
        ...
        <div className={`md:hidden mt-4 ${mobileMenuOpen ? "block" : "hidden"}`}>
          ...
          <nav className="mt-4 flex flex-col gap-2">
            <Link
              href="/home"
              className="text-black hover:text-blue-600 transition-colors py-2 border-b border-gray-100"
            >
              Home
            </Link>
            <Link
